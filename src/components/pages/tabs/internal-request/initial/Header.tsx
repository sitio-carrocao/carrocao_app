import type { formInternalRequestInitialSchema } from '@app/(tabs)/(internal-request)'
...
export default function InternalRequestInitialHeader({
  onSubmit,
  onClear,
}: IProps) {
  const form =
    useFormContext<z.infer<typeof formInternalRequestInitialSchema>>()
